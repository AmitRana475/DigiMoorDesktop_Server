...
namespace WorkShipVersionII.WorkHoursView
{
    ...
    /// </summary>
    public partial class AddMooringWinchTailView : UserControl
    {
        private readonly ShipmentContaxt sc;
        public AddMooringWinchTailView()
        {
        ...
        {
            AddMooringWinchTailViewModel._AddMooringWinchRope.IsRopeInstalled = "No";
        ...
        {
            AddMooringWinchTailViewModel._AddMooringWinchRope.IsRopeInstalled = "Yes";
        ...
        private void dpInsDate_CalendarClosed_1(object sender, RoutedEventArgs e)
        {
            try
            {
                var Frm = dpRecDate.Text;
