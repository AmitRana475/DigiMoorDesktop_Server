...
{
    public class AddTailDisposalViewModel : ViewModelBase
    {
        private readonly ShipmentContaxt sc;

        TextInfo textinfo = new CultureInfo("en-US", false).TextInfo;
        public AddTailDisposalViewModel(RopeDisposalClass edeps)
        {
        ...
        public AddTailDisposalViewModel()
        {
            StaticHelper.Editing = true;
