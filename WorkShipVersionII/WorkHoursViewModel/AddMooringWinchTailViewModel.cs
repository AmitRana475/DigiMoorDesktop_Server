...
{
       public class AddMooringWinchTailViewModel : ViewModelBase
       {
              private readonly ShipmentContaxt sc;

              TextInfo textinfo = new CultureInfo("en-US", false).TextInfo;
              public AddMooringWinchTailViewModel(MooringWinchRopeClass edeps)
              {
            ...
            saveCommand = new RelayCommand<MooringWinchRopeClass>(UpdateMooringWinch);
              ...
              public AddMooringWinchTailViewModel()
              {
            IsEnabledCheck = true;
            StaticHelper.Editing = true;
            ...
            saveCommand = new RelayCommand<MooringWinchRopeClass>(SaveMooringWinchRope);
              ...
              public ObservableCollection<RopeTypeCombo1> GetRopeType()
              {
        ...
        private void BrowseMethod()
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                if (size > 1024)
                {
                    System.Windows.Forms.MessageBox.Show("Attachment Size can not exceed 1MB !.", "Mooring RopeTail", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
        ...
        private void SaveMooringWinchRope(MooringWinchRopeClass moorwinchrope)
                     ...
                     try
            {
                ...
                if (CheckErrorMessage.CheckErrorMessages)
                {
                    ...
                    var duplicatecheck = sc.MooringWinchRope.Where(x => x.UniqueID == moorwinchrope.UniqueID && x.RopeTail == 1).Count();
                    ...
                    if (duplicatecheck == 0)
                    {
                        if (!string.IsNullOrEmpty(moorwinchrope.AttachmentPath))
                        {
                            ...
                            //else
                            //{
                            //    System.Windows.MessageBox.Show("Please Browse the file for Attachment", "Mooring RopeTail", MessageBoxButton.OK, MessageBoxImage.Warning);
                        ...
                        //else
                        //{
                        //    System.Windows.MessageBox.Show("Please enter the file name ", "Mooring RopeTail", MessageBoxButton.OK, MessageBoxImage.Warning);
                        ...
                        try
                        {
                            ...
                            {
                                SqlDataAdapter adp = new SqlDataAdapter("select * from tblRopeTailInspectionSetting where MooringRopeType=" + moorwinchrope.RopeTypeId + " and ManufacturerType=" + moorwinchrope.ManufacturerId + "", sc.con);
                        ...
                        //SqlDataAdapter adp5 = new SqlDataAdapter("select COUNT(*) from MooringRopeDetail where OutofServiceDate is null and RopeTail=1 and DeleteStatus=0", sc.con);
                        ...
                        //    {
                                ...
                                StaticHelper.Editing = false;
                        System.Windows.MessageBox.Show("Record saved successfully ", "Mooring RopeTail Detail", MessageBoxButton.OK, MessageBoxImage.Information);
                        ...
                        try
                        {
                            using (SqlDataAdapter adp = new SqlDataAdapter("InsertRopeAttachment", sc.con))
                            {
                                ...
                                adp.SelectCommand.Parameters.AddWithValue("@LineResidual", "RopeTail");
                        ...
                        //else
                        //{
                        //    MessageBox.Show("Rope tail not allowed more than " + StaticHelper.MinimumRopeTail + ". ", "Mooring RopeTail Detail", MessageBoxButton.OK, MessageBoxImage.Information);
                        ...
                        MooringWinchTailViewModel vm = new MooringWinchTailViewModel(lostdata);
                ...
                {
                    System.Windows.MessageBox.Show("UniqueID already exist !", "Mooring RopeTail Detail", MessageBoxButton.OK, MessageBoxImage.Information);
                    MainViewModelWorkHours.CommonValue = true;
                }
            }
                     catch (Exception ex)
                     ...
                     try
            {
                ...
                if (!string.IsNullOrEmpty(AddMooringWinchRope.AttachmentPath))
                {
                  ...
                  //  string subdir = @"C:\Temp\Mahesh";
                    ...
                    if (!string.IsNullOrEmpty(AddMooringWinchRope.AttachmentPath))
                    {
                        if (File.Exists(AddMooringWinchRope.AttachmentPath))
                        {
                            ...
                            if (ExtList.Contains(fileExtention.ToLower()))
                            {
                                ...
                                try
                                {
                                    SqlDataAdapter adp223 = new SqlDataAdapter("select * from MooringRopeAttachment where ropeid='" + moorwinch.Id + "' and LineResidual='RopeTail' and RopeTail=1", sc.con);
                            ...
                            {
                                System.Windows.MessageBox.Show("Invalid Attachment file.", "Add Rope Attachment", MessageBoxButton.OK, MessageBoxImage.Warning);
                            }
                        }
                        //else
                        //{
                    ...
                    //else
                    //{
                    //    System.Windows.MessageBox.Show("Please Browse the file for Attachment ", "Add Rope Attachment", MessageBoxButton.OK, MessageBoxImage.Warning);
                    //}
                }
                //else
                //{
                //    System.Windows.MessageBox.Show("Please enter the file name ", "Add Rope Attachment", MessageBoxButton.OK, MessageBoxImage.Warning);
                //}


                DateTime? instaldate = null;
                DateTime? recedate = null;
                MainViewModelWorkHours.CommonValue = false;
                ...
                if (CheckErrorMessage.CheckErrorMessages)
                {
                    ...
                    //var duplicatecheck = sc.MooringWinchRope.Where(x => x.UniqueID == moorwinch.UniqueID && x.RopeTail == 1).Count();
                    ...
                    if (dt11.Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            try
                            {
                                SqlDataAdapter adp = new SqlDataAdapter("select * from tblRopeTailInspectionSetting where MooringRopeType=" + moorwinch.RopeTypeId + " and ManufacturerType=" + moorwinch.ManufacturerId + "", sc.con);
                                DataTable dt = new DataTable();
                                adp.Fill(dt);
                                if (dt.Rows.Count > 0)
                                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            if (moorwinch.IsRopeInstalled == "Yes")
                            {
                                ...
                                SqlDataAdapter adpp1 = new SqlDataAdapter("select MAX(AssignedDate) as AssignedDate  from AssignRopeToWinch where RopeId=" + moorwinch.Id + " and IsActive=1 and RopeTail=1", sc.con);
                                DataTable ddt1 = new DataTable();
                                adpp1.Fill(ddt1);
                                if (ddt1.Rows.Count > 0)
                                {
                                    instaldate = ddt1.Rows[0][0] == DBNull.Value ? moorwinch.InstalledDate : Convert.ToDateTime(ddt1.Rows[0][0]);
                        ...
                        SqlDataAdapter adpp2 = new SqlDataAdapter("select MAX(SplicingDoneDate) as SplicingDoneDate from RopeSplicingRecord where RopeId=" + moorwinch.Id + " and IsActive=1 and RopeTail=1", sc.con);
                        DataTable ddt2 = new DataTable();
                        adpp2.Fill(ddt2);
                        if (ddt2.Rows.Count > 0)
                        {
                            // instaldate = Convert.ToDateTime(ddt2.Rows[0][0]);
                            recedate = ddt2.Rows[0][0].ToString() == "" ? moorwinch.ReceivedDate : Convert.ToDateTime(ddt2.Rows[0][0]);


                            if (moorwinch.ReceivedDate > recedate)
                            {
                        ...
                        SqlDataAdapter adpp3 = new SqlDataAdapter("select MAX(DamageDate) as DamageDate from ropedamagerecord where RopeId=" + moorwinch.Id + " and IsActive=1 and RopeTail=1", sc.con);
                        ...
                        if (ddt3.Rows.Count > 0)
                        {
                            ...
                            recedate = ddt3.Rows[0][0].ToString() == "" ? moorwinch.ReceivedDate : Convert.ToDateTime(ddt3.Rows[0][0]);
                        ...
                        SqlDataAdapter adpp4 = new SqlDataAdapter("select MAX(CroppedDate) as CroppedDate from RopeCropping where RopeId=" + moorwinch.Id + " and IsActive=1 and RopeTail=1", sc.con);
                        ...
                        if (ddt4.Rows.Count > 0)
                        {
                            ...
                            recedate = ddt4.Rows[0][0].ToString() == "" ? moorwinch.ReceivedDate : Convert.ToDateTime(ddt4.Rows[0][0]);
                        ...
                        using (SqlDataAdapter adp = new SqlDataAdapter("select * from MooringRopeAttachment where ropeid=" + moorwinch.Id + "", sc.con))
                        {
                            ...
                            else
                            {
                                ...
                                using (SqlDataAdapter adp2 = new SqlDataAdapter("InsertRopeAttachment", sc.con))
                                {
                                    ...
                                    adp2.SelectCommand.Parameters.AddWithValue("@RopeTail", 1);
                                    adp2.SelectCommand.Parameters.AddWithValue("@LineResidual", "RopeTail");
        ...
        private void refreshmessage1(MooringWinchRopeClass cdc1)
        {
            ...
            if (string.IsNullOrEmpty(cdc.RopeConstruction))
            {
                MainViewModelWorkHours.CommonValue = true;
                CheckErrorMessage.CheckErrorMessages = false;
                m.RopeConstructionMessage = "Please Select RopeTail Construction !";
                RaisePropertyChanged("AddMooringWinchRopeMessages");
            }
