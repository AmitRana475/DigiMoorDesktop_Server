...
{
    public class AddTailDamageRecordViewModel : ViewModelBase
    {
        private readonly ShipmentContaxt sc;
        TextInfo textinfo = new CultureInfo("en-US", false).TextInfo;

        public AddTailDamageRecordViewModel(RopeDamageRecordClass edeps)
        {
        ...
        public AddTailDamageRecordViewModel()
        {
            StaticHelper.Editing = true;
        ...
        private void Saveropespl(RopeDamageRecordClass rpspc)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                         notification = "Damaged - RopeTail " + ropename + " on winch " + WinchName + " located at " + WinchLocation + "";
                    }
                    else
                    {
                         notification = "Damaged - RopeTail " + ropename + "";
                    }
