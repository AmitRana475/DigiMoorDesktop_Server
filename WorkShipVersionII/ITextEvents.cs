...
namespace WorkShipVersionII 
{
    ...
    PdfContentByte cb;
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            //Phrase p1Header = new Phrase("KLNG Mooring System", baseFontNormal);
            ...
            var path = AppDomain.CurrentDomain.BaseDirectory + @"WorkshipManual - Copy\" + "logo.jpg";
            ...
            string s = "SECTION - MSLMP" + Environment.NewLine + "REVISION - " + StaticHelper.RNumber +  Environment.NewLine + "Uncontrolled Copy";
            //Create PdfTable object  
            PdfPTable pdfTab = new PdfPTable(3);
